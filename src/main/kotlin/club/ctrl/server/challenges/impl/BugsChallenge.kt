...
object BugsChallenge : Challenge {
    override val name: String = "Basics: Fix the bugs!"
    override val id: Int = -1
    override val subchallenges: List<Subchallenge> = listOf(BugsChallengeP0, BugsChallengeP1)
    override val isTeamChallenge: Boolean = false
}

object BugsChallengeP0 : Subchallenge {
    override val parent: Challenge = BugsChallenge
    ...
    override fun onSubmit(userId: String, submission: String, db: ChallengeCollection): SubmissionFeedback {
        ...
        return generateFeedback(submission, answer)
    }
}

object BugsChallengeP1 : Subchallenge {
    override val parent: Challenge = BugsChallenge
